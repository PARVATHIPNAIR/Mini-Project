...
?>
													<div class="stat-panel-number h1 "><?php echo $count1;?></div>
													<div class="stat-panel-title text-uppercase">Manage All Students </div>
												</div>
											</div>
											<a href="manage-students2.php" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
...
<p>Copyright © 2022 Hostel Managment. All rights reserved.</p>
</footer> </div>
